<header>
    <nav role="navigation" aria-label="Main navigation" class="flex-between-center">
        ...
        <ul role="list" class="flex">
            <li role="listitem" class="m-r-30"><a role="link" class="<?= $activeHub ?>link-menu" href="<?= $pathRedirect; ?>./">Hub</a></li>
            <li role="listitem" class="m-r-30"><a role="link" class="<?= $activeChampions ?>link-menu" href="<?= $pathRedirect; ?>champions">Champions</a></li>
